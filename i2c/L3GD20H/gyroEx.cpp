...
int *calibration(int file) {
    // Read data from I2C
    char regXlsb[1] = {0x28}, regXmsb[1] = {0x29};
    char regYlsb[1] = {0x2A}, regYmsb[1] = {0x2B};
    char regZlsb[1] = {0x2C}, regZmsb[1] = {0x2D};
        
    int length = 1;

    char dataXlsb[1] = {0}, dataXmsb[1] = {0};
    char dataYlsb[1] = {0}, dataYmsb[1] = {0};
    char dataZlsb[1] = {0}, dataZmsb[1] = {0};
...
int main()
{
    ...
    int xPast = 0, yPast = 0, zPast = 0;

    int *initData;
    initData = calibration(file);
    //xPast = *(initData); yPast = *(initData+1); zPast = *(initData+2);
